	...
	class Conversation extends Thread {
		...
		public void run() {
			try {
				...
				pw.println("Bienvenue vous tes le client numéro "+numeroClient);
				...
				while(true) {
					...
					if(fin == false) {
						if(nombre>nombreSecret) {
							pw.println("Votre nombre est superieur au nombreSecret");
						}else if(nombre<nombreSecret) {
							pw.println("Votre nombre est inferieur au nombreSecret");}
						else {
